let hotels = [
    ...
    },
    {
        ...
        capacity: 62000,
        description:"Brisa Barra Hotel has swimming pools for adults and children and is located in front of Barra da Tijuca Beach. It includes a gym, restaurant and dry and steam sauna. Free Wi-Fi is provided throughout and parking is available for an additional fee.",
        citiId: "riodejaneiro",
        userId:" adm2",
    },
    {
        ...
        capacity: 39000,
        description:"Get ready to live a unique experience in one of the most special and exclusive hotels in all of Barcelona. Art&Drinks, at the Hotel El Palace in Barcelona, offers you the opportunity to attend a beautiful illustration workshop led by the artist and illustrator Joel Miñana.",
        citiId: "barcelona",
        userId:"adm3",
    },
    {
        ...
        capacity:5000,
        description:"We're located 10 kilometers from Istanbul Airport and 30 minutes from the Mall of Istanbul with its shops, restaurants, and cinema. Vialand Theme Park is a 35-minute drive, and the Ataturk Olympic Stadium is 22 kilometers away. Get a workout in at our 24-hour fitness center and enjoy the convenience of our airport shuttle.",
        citiId: "istanbul",
        userId:"adm4",
    }
    ,{
    ...
    ,{
        ...
        capacity: 75000,
        description:"Star City Casino Wharf is located West of the Sydney Harbour Bridge just on Pyrmont Bay. Should this wharf be located near to you for your Sydney Harbour cruise it may be possible to pick up and drop off you and your guests here. Please be advised that due to the construction of some of the wharves on Sydney Harbour it may be unsuitable for the boat you are hiring. Our staff will be able to advise on the closest wharf that is suitable. A safe option to to select a wharf closer to Sydney CBD such as the King Street Wharfs in Darling Harbour.",
        citiId: "sydney",
        userId:"adm2",
    },
    {
    ...
    },
    {
        ...
        capacity: 90000,
        description:"El Sheraton Mall of the Emirates Hotel, Dubai comunica directamente con el centro comercial Mall of the Emirates y está a 20 minutos en auto del aeropuerto internacional DXB y de la Expo 2020. Hay wifi gratis en todas las instalaciones del hotel, incluidas las habitaciones.",
    ...
    },
    {
        ...
        capacity: 53000,
        description:"Our loving reanimation of the former flagship movie house of United Artists, The Theatre serves Los Angeles' burgeoning epicenter for art and modern entertainment with a prime setting for a wide array of events — from large-scale concerts to movie premieres, conferences, seminars, symposiums and other performances. Retrofitted with a state-of-theart digital projection system and cinema sound, an independent, ultramodern live sound system, plus an elaborate contemporary stage lighting system, the Theatre can take on whatever fits within the confines of its dazzling proscenium — a much needed bridge to the exciting future of Downtown Los Angeles.",
        citiId: "losangeles",
        userId:"adm1",
    },
    {
