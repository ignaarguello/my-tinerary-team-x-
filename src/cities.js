...
3- Barcelona (id: barcelona)
4- Istanbul (id: istanbul) *
5- Saint Petersburg (id: saintpetersburg) *
6- Sydney (id: sydney) *
7- Tokyo (id: tokyo) *
8- Emirate of Dubai (id: emirateofdubai) *
9- Los Angeles (id: losangeles)
10- Nairobi (id: nairobi)
11- Cairo (id: cairo) *
12- Rome (id: rome) *
*/